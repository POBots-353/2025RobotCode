...
//             state.position, state.velocity, (state.velocity - previousSetpoint.velocity) /
// 0.020);
...
//     return new TrapezoidProfile.State(getPosition().getRadians(),
// armAbsoluteEncoder.getVelocity());
//   }
